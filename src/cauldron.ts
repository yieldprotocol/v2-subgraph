...
import { Asset, Collateral, SeriesEntity, Vault, FYToken, Repay, Borrow } from "../generated/schema"
...
export function handleVaultPoured(event: VaultPoured): void {
  ...
  let eventId = event.transaction.hash.toHex() + '-' + event.transactionLogIndex.toString()
  if (isBorrow) {
